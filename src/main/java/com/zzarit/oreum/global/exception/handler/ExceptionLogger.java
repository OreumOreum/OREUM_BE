...
public class ExceptionLogger {
    ...
    public static void info(HttpServletRequest request, OreumException exception) {
    ...
    // MDC에 메타데이터 설정
    private static void setMDC(HttpServletRequest request, OreumException exception) {
