...
INSERT INTO folder (created_at, updated_at, name, member_id, is_default) VALUES
                                                                 (DATEADD('SECOND', 1, CURRENT_TIMESTAMP), NOW(), '모든 저장됨', 1,true),
                                                                 (DATEADD('SECOND', 2, CURRENT_TIMESTAMP), NOW(), '폴더1', 1,false),
                                                                 (DATEADD('SECOND', 3, CURRENT_TIMESTAMP), NOW(), '폴더2', 1,false),
...
INSERT INTO folder_place (created_at, updated_at, folder_id, place_id) VALUES
                                                                           ...
                                                                           (DATEADD('SECOND', 7, CURRENT_TIMESTAMP), DATEADD('SECOND', 7, CURRENT_TIMESTAMP), 2, 1),
                                                                           (DATEADD('SECOND', 8, CURRENT_TIMESTAMP), DATEADD('SECOND', 8, CURRENT_TIMESTAMP), 2, 2),
                                                                           (DATEADD('SECOND', 8, CURRENT_TIMESTAMP), DATEADD('SECOND', 8, CURRENT_TIMESTAMP), 2, 3),
                                                                           (DATEADD('SECOND', 8, CURRENT_TIMESTAMP), DATEADD('SECOND', 8, CURRENT_TIMESTAMP), 3, 1),
                                                                           (DATEADD('SECOND', 8, CURRENT_TIMESTAMP), DATEADD('SECOND', 8, CURRENT_TIMESTAMP), 3, 2),
                                                                           (DATEADD('SECOND', 8, CURRENT_TIMESTAMP), DATEADD('SECOND', 8, CURRENT_TIMESTAMP), 3, 3),
                                                                           (NOW(), NOW(), 4, 2),
                                                                           (NOW(), NOW(), 4, 5),
                                                                           (NOW(), NOW(), 5, 7),
                                                                           (NOW(), NOW(), 5, 1),
